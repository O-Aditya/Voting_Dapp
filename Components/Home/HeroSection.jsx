              ...
              <div class="pt-xxl-10 pb-xxl-10">
                <div class="circle-text first d-center cus-z1 position-absolute end-0 top-0 d-none d-xxl-flex  me-lg-10 mt-lg-10">
                  <div class="text d-center">
                    <p class="fs-six">The Future of Voting is Here</p>
                  </div>
                  <img
                ...
                Experience a voting system that ensures tamper-proof elections, real-time verification, and complete transparency
                </p>
